...
//  ProfitPulse
//
//  Created by Carlton Sempala on 24/03/2024.
//
...
struct AddSubscruiptionView: View {
    ...
    @State var subArr: [SubscriptionModel] = [
        SubscriptionModel(dict: ["id":0,"name":"Salaries", "icon":"Salaries_logo", "price": "5.99"] )
        ,
        SubscriptionModel(dict: ["id":1,
                                 "name": "Rent Premium",
                                 "icon": "Rent_logo",
                                 "price": "18.99"] )
        ,
        SubscriptionModel(dict: ["id " :2, "name": "Taxes", "icon": "Taxes_logo", "price": "15.00"] )
    ]
